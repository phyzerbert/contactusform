        ...
        <div class="container-fluid">
            <div class="card card-body w-100 d-inline-block">
                ...
                <div class="w-75 float-right">
                    <h3 class="mt-3">Welcome to Gracie Barra surfers Paradise</h3>
                        ...
                        <div class="card-body">
                            <table class="w-100 data-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="2" class="w-50">Occupation : <span class="item-value">{{$data['occupation']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="w-50">How did you hear about us? : <span class="item-value">{{$data['hear_us']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="w-50">Do you have a Medical Condition we need to be aware of? : <span class="item-value">{{$data['medical_condition']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="w-50">Do you have any previous Jiu-Jitsu Experience : <span class="item-value">{{$data['experience']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="w-50">Do you currently participate in any other sport or activity? : <span class="item-value">{{$data['participate']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="w-50">If not how long it has been since you participated in sport activity? : <span class="item-value">{{$data['how_long_participated']}}</span></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="w-50">What are the 3 main benefits you expect to get out of your Brazilian Jiu-Jtsu? : <span class="item-value">{{implode(', ', $data['benefits'])}}</span></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="w-100 data-table">
                                <tbody>                                    
                                    <tr>
                                        <td class="w-50">Name of the Participant : <span class="item-value">{{$data['participant_name']}}</span></td>
                                        <td class="w-50">Name of the Instructor/PD : <span class="item-value">{{$data['instructor_name']}}</span></td>
                                    </tr>
                                </tbody>
                            </table>
                            @php
