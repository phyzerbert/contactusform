...
class IndexController extends Controller
{
    ...
    public function testpdf(){
        $data = array(
            "first_name" => "Yuyuan",
            "last_name" => "sadfasdfasdf",
            "address" => "asdfsadfsafdsaf",
            ...
            "occupation" => "adsfasfa",
            "hear_us" => "asdfasfasfd",
            "medical_condition" => "asdfasfasdfsadfasdf",
            "experience" => "sadfasdfsadf",
            "participate" => "asdfsaf",
            "how_long_participated" => "sadfsadfasdfasdf",
            "benefits" => [
                0 => "Fitness",
                1 => "Discipline",
                2 => "Self-Defence",
            ...
            "participant_name" => "dfasdfasf",
            "instructor_name" => "dfasdfasf",
        ...
        return view('pdf.trial', compact('data'));
    }
}
